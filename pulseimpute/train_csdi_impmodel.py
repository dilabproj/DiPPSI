...
from configs.train_csdi_configs import *
...
if __name__=='__main__':
    ...
    model = model_module_class(config=config, modelname=config["modelname"], train_data=X_train, val_data=X_val, 
