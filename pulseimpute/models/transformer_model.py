...
class transformer():
    ...
    def data_loader_setup(self, train_data, val_data=None, imputation_dict=None):
        ...
        if val_data is not None:
            ...
            self.train_loader = torch.utils.data.DataLoader(train_dataset, batch_size=self.bs, shuffle=True, num_workers=0)
            ...
            self.val_loader = torch.utils.data.DataLoader(val_dataset, batch_size=self.bs, shuffle=False, num_workers=0)
        else:
            ...
            self.test_loader = torch.utils.data.DataLoader(test_dataset, batch_size=self.bs, shuffle=False, num_workers=0)
