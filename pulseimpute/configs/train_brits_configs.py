...
brits_i_512_mimic_ppg =  {'modelname':'brits_i', "annotate":"_512_mimic_ppg", 'modeltype':'brits', 
            ...
            "brits_data_path":"/mnt/1stHDD/nfs/roeywu/PPG_data/data/imputation_brits", "bigfile":True},
            "data_name":"mimic_ppg",
            "data_load": {"mean":True, "bounds":1},
            "train":{"iter_save":25, "bs": 128, "gpus":[0,1], "train_realppg":True, "createjson":True}}

brits_i_512_mimic_ecg =  {'modelname':'brits_i', "annotate":"_512_mimic_ecg", 'modeltype':'brits', 
            "modelparams":{"rnn_hid_size":512, "impute_weight":1, "label_weight":0, 
            "brits_data_path":"/mnt/1stHDD/nfs/roeywu/PPG_data/data/imputation_brits", "bigfile":False},
            "data_name":"mimic_ecg",
