...
bdc883_emb256_layer2_mimic_ppg_test = {'modelname':'bdc883_emb256_layer2', "annotate":"_mimic_ppg", 'modeltype':'transformer', 
            ...
            "data_name":"mimic_ppg","data_load": {"addmissing":True, "mean":True, "bounds":1, "train":False, "val":False, "test":True},
            "modelparams":{"convertolong":{"attention_window":[800,800], "attention_dilation":[4,4] }},
            "train":{"iter_save":100, "reload_epoch_long":54200,"bs": 2, "gpus":[3]}}
            # "train":{"iter_save":100, "reload_epoch_long":25700,"bs": 2, "gpus":[0,1]}}
...
bdc883_emb256_layer2_scientisst_ecg_test= {'modelname':'bdc883_emb256_layer2', "annotate":"_scientisst_ecg", 'modeltype':'transformer', 
             "annotate_test":"_test",
            "data_name":"scientisst_ecg","data_load": {"train":False, "val":False, "test":True, "addmissing":True, "impute_transient":{"window":50, "prob":.30}},
            "modelparams":{"convertolong":{"attention_window":[800,800], "attention_dilation":[4,4] }},
            "train":{"iter_save":100, "reload_epoch_long":47000,"bs": 4, "gpus":[0]}}
bdc883_emb256_layer2_wireless_ppg_test= {'modelname':'bdc883_emb256_layer2', "annotate":"_wireless_ppg", 'modeltype':'transformer', 
             "annotate_test":"_test",
            "data_name":"wireless_ppg","data_load": {"train":False, "val":False, "test":True, "addmissing":True, "impute_transient":{"window":50, "prob":.30}},
            "modelparams":{"convertolong":{"attention_window":[800,800], "attention_dilation":[4,4] }},
            "train":{"iter_save":100, "reload_epoch_long":54200,"bs": 4, "gpus":[0]}}
...
deepmvi_scientisst_ecg_test = {'modelname':'deepmvi', "annotate":"_scientisst_ecg", 'modeltype':'transformer', 
             "annotate_test":"_test",
            "data_name":"scientisst_ecg","data_load": {"train":False, "val":False, "test":True, "addmissing":True, "impute_transient":{"window":50, "prob":.30}},
            "modelparams":{"reload_epoch_long":"1892000","convertolong":{"attention_window":[800,800], "attention_dilation":[4,4] }},
            "train":{"iter_save":100,"bs": 4, "gpus":[0], "train_realecg":True}}
...
deepmvi_mimic_ppg_test = {'modelname':'deepmvi', "annotate":"_mimic_ppg", 'modeltype':'transformer', 
            ...
            # "modelparams":{"reload_epoch_long":"64000", "convertolong":{"attention_window":[800,800], "attention_dilation":[4,4] }},
            "train":{"iter_save":1000, "bs": 4, "gpus":[3], "train_realppg":True}}

deepmvi_wireless_ppg_test = {'modelname':'deepmvi', "annotate":"_wireless_ppg", 'modeltype':'transformer', 
             "annotate_test":"_test",
            "data_name":"wireless_ppg","data_load": {"train":False, "val":False, "test":True, "addmissing":True, "impute_transient":{"window":50, "prob":.30}},
            "modelparams":{"reload_epoch_long":"1892000","convertolong":{"attention_window":[800,800], "attention_dilation":[4,4] }},
            "train":{"iter_save":100,"bs": 4, "gpus":[0], "train_realecg":True}}
